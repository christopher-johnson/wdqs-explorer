...
gulp.task('browserifyWithDeps', function() {
	var bundler = browserify({entries: ["./src/entry.js"],standalone: "WDQS-EXPLORER", debug: true});
...
gulp.task('browserifyForDebug', function() {
	var bundler = browserify({entries: ["./src/entry.js"],standalone: "WDQS-GUI", debug: true});
